...
* Modifications: 1/11/25 – Created The lab
*				 1/12/25 - Fixed List.h declerations & started working on definitions
*				 1/13/25 - Fixed & Correctly implemented the copy ctor and assignment operator & wrote other definitons 
*				 1/14/25 - Fixed Node class defintions and declerations
*				 1/15/25 – Finished Lab & Corrected Insert Functions as well as Extract Function
**************************************************************/

/*************************************************************
*
* Lab/Assignment: Lab 2 – Doubly LinkedList
*
* Overview:
* The point in this assignment is to successfully implement a doubly linked list with all the main
* manager functions as well as given functions to correctly test the methods of the linkedlist.
* We must successfully be able to create, copy, and move a node with the best manager functions; 
* as well as insert a new node before an existing one as well as after an existing one, extract a certain node, as well as 
* delete and print the list as we please
*
* Input:
* No external input is taken other than from the tests. We must however be able to take regular and complex data types
* into the linked list with no trouble. 
*
* Output:
* The output for this lab comes from the test code, which tells us if our manager functions and other functions are correctly 
