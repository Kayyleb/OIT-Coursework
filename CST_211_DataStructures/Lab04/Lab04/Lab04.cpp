...
/*************************************************************
*
* Lab/Assignment: Lab 4 – 2D-Array 2nd Implementation
*
* Overview:
* This program is to create a 2 Dimensional Array class,
* that takes in both complex and regular data types. We then have a 
* friend Row class to help create the rows for our Array2D class.
* This program is to take in a T** m_array data type instead of one
* made from our previous class, which is an array of pointers that
* all point to new arrays (2 star pointer).
*
* Input:
* Considering our function is only designed to take in templated
* data types and regular data types, our only input comes from the
* test.cpp file provided to us with the lab.
*
* Output:
*The output of this program is based on the test.cpp file that was
* provided, testing and outputing if we passed each test based on
* each function created. The output of the program will look like this:
* Upper bounds row test passed
* Upper bounds column test passed
* Default ctor test passed
* 2 arg ctor test passed
* set row test passed
* set col test passed
* Adding data test passed
* Copy ctor test passed
* Op eql test passed
* Increase rows with data test passed
* Decrease rows with data test passed
* Increase cols with data test passed
* Decrease cols with data test passed
* Negative row test complex passed
* Negative column test complex passed
* Upper bounds row test complex passed
* Upper bounds column test complex passed
* Default ctor test complex passed
* 2 arg ctor test complex passed
* set row test complex passed
* set col test complex passed
* Adding data test complex passed
* Copy ctor test complex passed
* Op eql test complex passed
* Increase rows with data test complex passed
* Decrease rows with data test complex passed
* Increase cols with data test complex passed
* Decrease cols with data test complex passed
************************************************************/
